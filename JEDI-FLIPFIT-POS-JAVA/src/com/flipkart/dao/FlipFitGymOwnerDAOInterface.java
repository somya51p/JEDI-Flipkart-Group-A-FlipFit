...
/**
 * Interface for data access operations related to Gym Owners in FlipFit application.
 */
public interface FlipFitGymOwnerDAOInterface {

    /**
     * Creates a Gym Owner with the specified details.
     *
    ...
    /**
     * Registers a Gym under a Gym Owner.
     *
     * @param userId    The user ID of the Gym Owner.
    ...
    /**
     * Removes a Gym owned by a Gym Owner.
     *
    ...
    /**
     * Retrieves a list of all Gyms registered by a Gym Owner.
     *
     * @param userId   The user ID of the Gym Owner.
    ...
    /**
     * Retrieves a list of all bookings made across all Gyms owned by a Gym Owner.
     *
     * @param userId   The user ID of the Gym Owner.
    ...
    /**
     * Retrieves available slots for a specific Gym.
     *
     * @param gymId   The ID of the Gym to retrieve available slots for.
     * @return        List of available slots for the Gym.
     */
